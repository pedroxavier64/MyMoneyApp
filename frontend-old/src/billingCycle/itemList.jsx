...
class ItemList extends Component {
    ...
    remove(index) {
        if(!this.props.readOnly && this.props.list.lentgh > 1) {
            this.props.arrayRemove('billingCycle', this.props.field , index)
        }
    }
...
mapDispatchToProps = dispatch => bindActionCreators({arrayInsert, arrayRemove}, dispatch)
